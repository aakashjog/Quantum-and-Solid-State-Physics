...
plot(x2,normpdf(x2,0,sigma_2))
plot(x3,normpdf(x3,0,sigma_3))
plot(x4,normpdf(x4,0,sigma_4))
...
print(fig,'pulse_of_light_without_eletric_field','-dpdf','-r0')

close all; clear; clc;

! cp pulse_of_light_without_eletric_field.pdf ../fig-pulse_of_light_without_eletric_field.pdf
